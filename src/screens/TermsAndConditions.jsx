            ...
            <div className="col-12">
              ...
              <div className="mt-5">
                ...
                >
                  ...
                  to it, still belong to Moksha Worldwide.
                </p>
                <p
                  className="m-0 mt-5"
                  style={{
                ...
                >
                  Moksha Worldwide is committed to ensuring that the app is as
                ...
                >
                  The My Edukos app stores and processes personal data that you
                  ...
                  security features and it could mean that the My Edukos app
                ...
                >
                  You should be aware that there are certain things that Moksha
                  Worldwide will not take responsibility for. Certain functions
                  of the app will require the app to have an active internet
                  connection. The connection can be Wi-Fi, or provided by your
                  mobile network provider, but Moksha Worldwide cannot take
                ...
                >
                  Along the same lines, Moksha Worldwide cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged – if it runs out of
                  battery and you can’t turn it on to avail the Service, Moksha
                  Worldwide cannot accept responsibility.
                </p>
                <p
                  className="m-0 mt-5"
                  style={{
                ...
                >
                  With respect to Moksha Worldwide’s responsibility for your use
                  ...
                  to you. Moksha Worldwide accepts no liability for any loss,
                ...
                >
                  ...
                  app. Moksha Worldwide does not promise that it will always
                ...
                >
                  ...
                  Conditions, do not hesitate to contact us at 6377675707.
                </p>
              </div>
            </div>
          </div>
